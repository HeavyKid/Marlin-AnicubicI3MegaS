...
#define STRING_CONFIG_H_AUTHOR "Heavykid" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 116.90
  #define DEFAULT_bedKi 23.01
  #define DEFAULT_bedKd 395.87
...
#define Z_MIN_PROBE_ENDSTOP_INVERTING fasle // Set to true to invert the logic of the probe.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -1, -24, -2.4 }
